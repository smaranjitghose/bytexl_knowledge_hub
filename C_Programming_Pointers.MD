...
Here are all 10 problems with **7 test cases each** and **clean C solutions** using only basic data types (`int`, `float`, `char`, arrays, and pointers). No `long long`, `double`, or advanced types are used.
